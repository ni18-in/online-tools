// --- Initialization ---
        ...
        const initialContent = `## Bienvenue dans le Convertisseur Markdown vers Word

Ceci est un outil de conversion **cote client**.

## Fonctionnalites
- Convertir du **Markdown** en Word
- Prend en charge l'*Italique* et le __Gras__
- Listes et Tableaux

| Fonctionnalite | Support |
|-----------------|---------|
| Tableaux        | Oui     |
| Listes          | Oui     |
...
`;
        ...
        async function copyRichText() {
            ...
            try {
                ...
                alert('Texte enrichi copie dans le presse-papiers !');
            } catch (err) {
                console.error('Failed to copy', err);
                alert('Echec de la copie du texte.');
            }
        ...
        async function downloadDocx() {
            ...
            let filename = "document-markdown.docx";
            ...
            docx.Packer.toBlob(doc).then((blob) => {
                ...
                alert("Erreur lors de la generation du document. Consultez la console.");
            });
        }
