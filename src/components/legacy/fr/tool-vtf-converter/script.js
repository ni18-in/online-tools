document.addEventListener('DOMContentLoaded', () => {
    ...
    convertBtn.addEventListener('click', async () => {
        ...
        setLoading(true);
        statusMsg.textContent = 'Génération du VTF en cours...';
        ...
        try {
            ...
            statusMsg.textContent = 'Conversion réussie ! Le téléchargement a démarré.';
    ...
    async function generateVTF(img, resizeMode) {
        ...
        if (resizeMode === 'nearest') {
            ...
            if (!isPowerOfTwo(width) || !isPowerOfTwo(height)) {
                if (!confirm("Attention : Le moteur Source requiert des dimensions en puissance de deux (par exemple 256, 512). Votre image fait " + width + "x" + height + ". Elle risque de ne pas se charger dans le jeu. Continuer ?")) {
