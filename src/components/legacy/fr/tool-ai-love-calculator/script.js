// DOM Element References
        ...
        function getCompatibilityDetails(score) {
            if (score >= 90) {
                return {
                    ...
                    prediction: "Votre avenir est rempli de roses et de soirées pizza à l'infini !"
                };
            } else if (score >= 70) {
                return {
                    status: "Connexion Forte 💕",
                    prediction: "Vous vous complétez parfaitement. Un match fait au paradis numérique."
                };
            } else if (score >= 50) {
                return {
                    status: "Compatibilité Moyenne 🙂",
                    prediction: "Il y a du potentiel ! Un mélange de petits drames et de bons moments."
                };
            } else if (score >= 30) {
                return {
                    status: "Compatibilité Difficile 💔",
                    prediction: "Cela pourrait demander beaucoup de patience, de Netflix, et peut-être des couvertures séparées."
                };
            } else {
                return {
                    status: "Oups ! 🚫",
                    prediction: "Les étoiles ne sont pas alignées. Avez-vous envisagé d'adopter un chien ?"
                };
            }
        }
        ...
        calculateBtn.addEventListener('click', () => {
            ...
            if (age1 <= 0 || age2 <= 0) {
                errorMessage.textContent = "L'âge doit être un nombre positif.";
                return;
            }
        ...
        shareBtn.addEventListener('click', () => {
            ...
            const textToCopy = `Mon score d'amour est ${score} ! L'IA dit que c'est « ${status} ». Découvrez le vôtre !`;
            ...
            try {
                ...
                shareFeedback.textContent = 'Résultat copié dans le presse-papiers !';
            } catch (err) {
                shareFeedback.textContent = 'Impossible de copier le résultat.';
