// --- State ---
        ...
        function updateClock() {
            ...
            els.currentLocal.textContent = now.toLocaleString('fr-FR');
        }

        function toggleClock() {
            clockRunning = !clockRunning;
            els.pauseBtn.textContent = clockRunning ? "Pause" : "Reprendre";
            if (clockRunning) {
                updateClock();
            }
        }
        ...
        function processInput() {
            ...
            try {
                if (isTimestamp) {
                    ...
                    if (isNaN(parsed)) throw new Error("Format de date invalide");
                ...
                els.errorMsg.textContent = "Oups ! Impossible d'analyser cela. Essayez un format standard comme '2024-01-01' ou un timestamp numérique.";
        ...
        function displayResults(date) {
            ...
            els.resLocal.textContent = date.toLocaleString('fr-FR');
            ...
            els.resDetails.textContent = `Année bissextile : ${isLeap ? "Oui" : "Non"} | Jour de l'année : ${dayOfYear}`;
        ...
        function updateTimezone() {
            ...
            try {
                els.resTzConverted.textContent = new Intl.DateTimeFormat('fr-FR', {
                    dateStyle: 'full',
                    timeStyle: 'long',
                    timeZone: tz
                }).format(lastConvertedDate);
            } catch (e) {
                els.resTzConverted.textContent = "Erreur de conversion du fuseau horaire";
            }
        }
