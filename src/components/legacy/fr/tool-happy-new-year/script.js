...
if (fromName) {
    // Mode A: View Wish
    document.title = `Bonne Annee de la part de ${fromName} !`;
    senderNameDisplay.textContent = fromName;
    customMessageDisplay.textContent = customMsg || `Je vous souhaite une annee fantastique remplie de joie et de succes ! Bonne annee ${year} !`;
...
wishForm.addEventListener('submit', (e) => {
    ...
    // Update Social Links
    const shareText = `Bonne Annee ! 🎉 Un voeu special de ${name}`;
