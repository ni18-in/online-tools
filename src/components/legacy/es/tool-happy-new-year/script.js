...
if (fromName) {
    // Mode A: View Wish
    document.title = `Feliz Ano Nuevo de parte de ${fromName}!`;
    senderNameDisplay.textContent = fromName;
    customMessageDisplay.textContent = customMsg || `Te deseo un ano fantastico lleno de alegria y exito! Feliz ${year}!`;
...
wishForm.addEventListener('submit', (e) => {
    ...
    // Update Social Links
    const shareText = `Feliz Ano Nuevo! 🎉 Un deseo especial de ${name}`;
